...
namespace Company.MobileDSL
{
	...
	/// </remarks>
	public partial class MobileDSLHelpKeywordHelper : MobileDSLHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new MobileDSLHelpKeywordHelper.
		/// </summary>
		protected MobileDSLHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the MobileDSLHelpKeywordHelper.
		/// </summary>
		public static MobileDSLHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class MobileDSLHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new MobileDSLHelpKeywordHelperBase.
		/// </summary>
		protected MobileDSLHelpKeywordHelperBase()
			: base() { }
