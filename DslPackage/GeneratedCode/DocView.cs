...
namespace Company.MobileDSL
{
	...
	/// </summary>
	internal partial class MobileDSLDocView : MobileDSLDocViewBase
	{
		/// <summary>
		/// Constructs a new MobileDSLDocView.
		/// </summary>
		public MobileDSLDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class MobileDSLDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new MobileDSLDocView.
		/// </summary>
		protected MobileDSLDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			MobileDSLDocDataBase docData = this.DocData as MobileDSLDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for MobileDSLDocViewBase should be an MobileDSLDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::Company.MobileDSL.MobileDSLDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::Company.MobileDSL.MobileDSLDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::Company.MobileDSL.MobileDSLToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::Company.MobileDSL.MobileDSLToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.MobileDSLDiagramMenu;
			}
		}
			...
			if(global::Company.MobileDSL.MobileDSLHelpKeywordHelper.Instance != null)
			{
				...
				if(selectedElement != null)
				{
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::Company.MobileDSL.MobileDSLHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
